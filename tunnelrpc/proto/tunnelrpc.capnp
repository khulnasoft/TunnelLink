...
@0xdb8274f9144abc7e;
$Go.package("proto");
$Go.import("github.com/khulnasoft/tunnellink/tunnelrpc");
...
struct RegistrationOptions @0xc793e50592935b4a {
    ...
    # Set of features this tunnellink knows it supports
...
interface SessionManager @0x839445a59fb01686 {
    # Let the edge decide closeAfterIdle to make sure tunnellink doesn't close session before the edge closes its side
...
struct UpdateConfigurationResponse @0xdb58ff694ba05cf9 {
    ...
    # that tunnellink is using an older configuration because the latest cannot be applied
    latestAppliedVersion @0 :Int32;
    # Any error encountered when trying to apply the last configuration
    err @1 :Text;
}

# ConfigurationManager defines RPC to manage tunnellink configuration remotely
...
interface TunnellinkServer @0xf548cef9dea2a4a1 extends(SessionManager, ConfigurationManager) {}