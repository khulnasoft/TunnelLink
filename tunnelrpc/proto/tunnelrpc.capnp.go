...
type TunnellinkServer struct{ Client capnp.Client }

// TunnellinkServer_TypeID is the unique identifier for the type TunnellinkServer.
const TunnellinkServer_TypeID = 0xf548cef9dea2a4a1

func (c TunnellinkServer) RegisterUdpSession(ctx context.Context, params func(SessionManager_registerUdpSession_Params) error, opts ...capnp.CallOption) SessionManager_registerUdpSession_Results_Promise {
	if c.Client == nil {
		return SessionManager_registerUdpSession_Results_Promise{Pipeline: capnp.NewPipeline(capnp.ErrorAnswer(capnp.ErrNullClient))}
	}
	call := &capnp.Call{
...
func (c TunnellinkServer) UnregisterUdpSession(ctx context.Context, params func(SessionManager_unregisterUdpSession_Params) error, opts ...capnp.CallOption) SessionManager_unregisterUdpSession_Results_Promise {
	if c.Client == nil {
		return SessionManager_unregisterUdpSession_Results_Promise{Pipeline: capnp.NewPipeline(capnp.ErrorAnswer(capnp.ErrNullClient))}
	}
	call := &capnp.Call{
...
func (c TunnellinkServer) UpdateConfiguration(ctx context.Context, params func(ConfigurationManager_updateConfiguration_Params) error, opts ...capnp.CallOption) ConfigurationManager_updateConfiguration_Results_Promise {
	if c.Client == nil {
		return ConfigurationManager_updateConfiguration_Results_Promise{Pipeline: capnp.NewPipeline(capnp.ErrorAnswer(capnp.ErrNullClient))}
	}
	call := &capnp.Call{
...
type TunnellinkServer_Server interface {
	RegisterUdpSession(SessionManager_registerUdpSession) error
...
func TunnellinkServer_ServerToClient(s TunnellinkServer_Server) TunnellinkServer {
	c, _ := s.(server.Closer)
	return TunnellinkServer{Client: server.New(TunnellinkServer_Methods(nil, s), c)}
}

func TunnellinkServer_Methods(methods []server.Method, s TunnellinkServer_Server) []server.Method {
	if cap(methods) == 0 {
		methods = make([]server.Method, 0, 3)
	}
