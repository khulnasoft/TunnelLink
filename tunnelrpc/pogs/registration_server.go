...
type RegistrationServer interface {
	...
	// UnregisterConnection is the call typically handled by the edge to close an existing connection for tunnellink.
	UnregisterConnection(ctx context.Context)
	// UpdateLocalConfiguration is the call typically handled by the edge for tunnellink to provide the current
