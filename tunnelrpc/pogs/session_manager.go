...
type SessionManager interface {
	// RegisterUdpSession is the call provided to tunnellink to handle an incoming
	...
	// UnregisterUdpSession is the call provided to tunnellink to handle an incoming
