...
const (
	metricsNamespace = "tunnellink"
	rpcSubsystem     = "rpc"
)

// TunnellinkServer operation labels
// TunnellinkServer is an extension of SessionManager with additional methods, but it's helpful
