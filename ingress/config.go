...
// OriginRequestConfig configures how Tunnellink sends requests to origin
// services.
...
// SetConfig gets config for the requests that tunnellink sends to origins.
...
//  3. Defaults chosen by the tunnellink team
