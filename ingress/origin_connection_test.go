...
import (
	...
	"github.com/khulnasoft/tunnellink/websocket"
)

const (
	testStreamTimeout = time.Second * 3
	echoHeaderName    = "Test-Tunnellink-Echo"
)
...
// Eyeball side runs tunnellink access tcp with --url flag to start a websocket forwarder which
