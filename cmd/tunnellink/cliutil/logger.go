...
var (
	debugLevelWarning = "At debug level tunnellink will log request URL, method, protocol, content length, as well as, all request and response headers. " +
...
func ConfigureLoggingFlags(shouldHide bool) []cli.Flag {
	return []cli.Flag{
		...
		altsrc.NewStringFlag(&cli.StringFlag{
			Name:    "trace-output",
			Usage:   "Name of trace output file, generated when tunnellink stops.",
