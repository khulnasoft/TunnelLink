...
func serviceAlreadyExistsWarn(service string) string {
	return fmt.Sprintf("tunnellink service is already installed at %s; if you are running a tunnellink tunnel, you "+
		"can point it to multiple origins, avoiding the need to run more than one tunnellink service in the "+
		"same machine; otherwise if you are really sure, you can do `tunnellink service uninstall` to clean "+
