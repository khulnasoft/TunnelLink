...
$TunnellinkDirectory = "$WorkingDirectory\go\src\github.com\khulnasoft\tunnellink"
...
Write-Output "Building tunnellink"

& make tunnellink
if ($LASTEXITCODE -ne 0) { throw "Failed to build tunnellink" }
