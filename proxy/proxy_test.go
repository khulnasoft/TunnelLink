...
// eyeball sends tcp packets wrapped in websockets. (E.g: tunnellink access).
	...
	var tests = []struct {
		...
		},
		{
			...
			args: args{
				...
				requestHeaders: map[string][]string{
					"Cf-Tunnellink-Proxy-Src": {"non-blank-value"},
				},
			},
			want: want{
