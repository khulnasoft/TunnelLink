...
import (
	...
	"github.com/khulnasoft/tunnellink/datagramsession"
...
// It also serves as a demonstration for communication with the QUIC connection started by a tunnellink.
func TestQUICServer(t *testing.T) {
	...
	var tests = []struct {
		...
		},
		{
			...
			metadata: []pogs.Metadata{
				{
					Key: "HttpHeader:Cf-Tunnellink-Proxy-Connection-Upgrade",
					Val: "Websocket",
				},
				{
...
func runRPCServer(ctx context.Context, session quic.Connection, sessionRPCServer pogs.SessionManager, configRPCServer pogs.ConfigurationManager, t *testing.T) {
	...
	ss := rpcquic.NewTunnellinkServer(
