...
from util import LOGGER, start_tunnellink, write_config, wait_tunnel_ready
...
class TestTail:
    ...
    async def test_start_stop_streaming(self, tmp_path, component_tests_config):
        ...
        with start_tunnellink(tmp_path, config, cfd_args=["run", "--hello-world"], new_process=True):
