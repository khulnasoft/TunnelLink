...
class PkgCreator:
    ...
    """
        ...
        [tunnellink-stable]
        name=tunnellink-stable
        baseurl=https://pkg.khulnasoft.com/tunnellink/rpm
        enabled=1
        type=rpm
        gpgcheck=1
...
""" 
    1. looks into a built_artifacts folder for tunnellink debs
    ...
    release_version: is the tunnellink release version. Only provide this if you want a permanent backup.
"""
...
def create_deb_packaging(pkg_creator, pkg_uploader, releases, gpg_key_id, binary_name, archs, package_component,
    ...
    for release in releases:
        for arch in archs:
            ...
            pkg_creator.create_deb_pkgs(release, f"./built_artifacts/tunnellink-linux-{arch}.deb")
